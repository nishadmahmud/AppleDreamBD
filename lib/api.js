 ...
 */
export const getCategoryProducts = (categoryId, page = DEFAULT_PAGE, limit = DEFAULT_LIMIT) => {
 ...
 */
export const fetchCategoryProducts = async (categoryId, page = DEFAULT_PAGE, limit = DEFAULT_LIMIT) => {
