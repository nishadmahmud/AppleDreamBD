export default function DealOfDay() {
  return (
    <section className="px-4 sm:px-8 lg:px-10 py-16">
      <div className="bg-gray-100 rounded-xl p-8 flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">Apple Watch Ultra 2</h2>
          <p className="text-gray-600 mt-4">Next-level adventure. The most rugged and capable Apple Watch pushes limits again. Featuring an all-new S9 SiP and a magical new way to use your watch without touching the screen.</p>
          <div className="flex justify-center lg:justify-start gap-4 my-6">
            <div className="text-center bg-background-light p-3 rounded-lg w-20">
