    ...
    <section className="px-4 sm:px-8 lg:px-10 py-16">
      <div className="bg-gray-100 dark:bg-background-dark/50 rounded-xl p-8 flex flex-col lg:flex-row items-center gap-8 transition-colors duration-300">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mt-2 transition-colors duration-300">
            Apple Watch Ultra 2
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mt-4 transition-colors duration-300">
