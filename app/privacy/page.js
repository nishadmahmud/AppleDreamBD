        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark/60 mb-10">
          ...
          <div className="relative p-6 md:p-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
              How we collect, use, share, and protect your information across
              our website, checkout, and customer support experiences.
            </p>
          </div>
        </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <ul>
                  <li>
                    Account details (name, email, contact info) you provide.
                  </li>
                  <li>
                    Order and payment details processed by secure gateways.
                  </li>
                  <li>
                    Usage data (pages visited, device type, browser) to improve
                    the site.
                  </li>
                </ul>
              </div>
            ...
            >
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <ul>
                  <li>
                    To process and fulfill orders, and provide customer support.
                  </li>
                  <li>
                    To personalize content, recommendations, and marketing (with
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300">
                We do not sell your data. Limited sharing with logistics and
                payment partners is performed strictly to fulfill orders and
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300">
                We use industry-standard practices to protect your data during
                transmission and storage, including HTTPS, limited access
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                analyze site usage. You can control cookies via your browser
                settings.
              </p>
            </section>
